...
class ObjectDetector_robothor_ogn:

    def __init__(self):

        # Use Faster RCNN object detector pretrained on MSCOCO and finetuned on ITHOR custom dataset with 12 classes
        self.model = FasterRCNN_robothor_ogn()
